...
func (m *Model) View() string {
	...
	help := theme.Help.Render("1:compartments  2:log groups  3:logs  4:search  enter:open/search  space:select  s:search  esc:up  r:refresh  tab:next/field  pgup/pgdn:scroll  home/end:top/bottom  ctrl+y:copy json  ctrl+o:copy query  q:quit")
